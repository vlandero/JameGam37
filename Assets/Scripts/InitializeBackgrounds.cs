...
public class InitializeBackgrounds : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        tire1.transform.localPosition = new Vector3(mainCamera.transform.position.x - mainCamera.width / 2 - 10, 0.15f, 0);
    ...
    private void MoveBackgrounds()
    {
        ...
        {
            movingBackground1.transform.position += new Vector3(backgroundSpriteWidth * 2 - .2f, 0, 0);
        }

        if (movingBackground2.transform.position.x + backgroundSpriteWidth < mainCamera.transform.position.x - mainCamera.width / 3)
        {
            movingBackground2.transform.position += new Vector3(backgroundSpriteWidth * 2 -.2f, 0, 0);
        }
    }
    ...
    private void MoveFloors()
    {
        ...
        {
            floor1.transform.localPosition += new Vector3(floorSpriteWidth * 2 -.2f, 0, 0);
        }

        if (floor2.transform.position.x + floorSpriteWidth < mainCamera.transform.position.x - mainCamera.width / 10)
        {
            floor2.transform.localPosition += new Vector3(floorSpriteWidth * 2 -.2f, 0, 0);
        }
    }
    ...
    private void MoveTires()
    {
        ...
        {
            tire1.transform.localPosition += new Vector3(tireTranslate * 2 -.2f, 0, 0);
        }
        if (tire2.transform.position.x + tireSpriteWidth / 2 < mainCamera.transform.position.x - mainCamera.width / 2)
        {
            tire2.transform.localPosition += new Vector3(tireTranslate * 2 -.2f, 0, 0);
        }
    }
